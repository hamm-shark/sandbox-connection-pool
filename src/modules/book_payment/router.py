...
from src.modules.book_payment.routers.out_session import (
    no_tr_router as out_session_no_tr_router,
    tr_router as out_session_tr_router,
)
...
router.include_router(out_session_tr_router)
router.include_router(out_session_no_tr_router)
